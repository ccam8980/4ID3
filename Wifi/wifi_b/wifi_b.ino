...
void reconnect() {
//While the client remains unconnected from the MQTT broker, attempt to reconnect every 2seconds
...
client.publish("4ID3_Group1/temperature", String(dhtTempEvent.temperature).c_str());
delay(100);
client.publish("4ID3_Group1/humidity", String(dhtHumEvent.relative_humidity).c_str());
delay(100);
client.publish("4ID3_Group1/pressure", String(bmpEvent.pressure).c_str());
delay(100);
client.publish("4ID3_Group1/light", String(lux).c_str());
